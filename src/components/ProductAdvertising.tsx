...
const ProductAdvertising = () => {
  return (
    <div className='w-[100%] p-4 md:w-[80%] mx-auto mb-4 flex flex-col md:flex-row gap-4 mt-12 md:mt-24'>
      ...
      <div className='w-full md:w-1/2 mt-4 md:mt-12  md:px-0'>
      <h3 className='text-3xl sm:text-4xl md:text-6xl font-bold text-gray-500'>About the <span className='text-green-400'>Doffy</span></h3>
      <p className='pt-4 opacity-70 text-sm sm:text-base md:text-lg'>The Doofy was announced at CES2017, is an early education consumer robot for children. It has received the best honor at red dot award 2017-a top international product and communication design prize beating thousands of other quality entries from more than 60 countries.</p>
