...
const Sidebar = () => {
  ...
  const menuItems = [
    {
      path: `/${currentLang}/profile`, label: t('sidebar_title_profile')
      , icon: (
    ...
    {
      path: `/${currentLang}/profile/orders`, label: t('sidebar_title_orders'), icon: (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
    ...
    {
      path: `/${currentLang}/profile/security`, label: t('sidebar_title_security'), icon: (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
    ...
    <div className="w-full md:w-[20%]">
      <ul className="w-full grid md:grid-cols-1 text-center md:text-left grid-cols-4">
        ...
        >
          ...
          <span className="hidden md:inline">{t('sidebar_title_logout')}</span>
        </li>
      </ul>
    </div>
  );
